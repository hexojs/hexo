...
describe('img', () => {
  ...
  it('src', () => {
    ...
    $('img')
      .attr('src')
      .should.eql('https://placekitten.com/200/300');
  });
  ...
  it('src //', () => {
    ...
    $('img')
      .attr('src')
      .should.eql('//placekitten.com/200/300');
  });
  ...
  it('internal src', () => {
    ...
    $('img')
      .attr('src')
      .should.eql('/root/images/test.jpg');
  });

  it('class + src', () => {
    const $ = cheerio.load(
      img('left https://placekitten.com/200/300'.split(' '))
    );
  ...
  it('multiple classes + src', () => {
    const $ = cheerio.load(
      img('left top https://placekitten.com/200/300'.split(' '))
    );
  ...
  it('class + src + width', () => {
    const $ = cheerio.load(
      img('left https://placekitten.com/200/300 200'.split(' '))
    );
  ...
  it('class + src + width + height', () => {
    const $ = cheerio.load(
      img('left https://placekitten.com/200/300 200 300'.split(' '))
    );
  ...
  it('class + src + title', () => {
    const $ = cheerio.load(
      img('left https://placekitten.com/200/300 Place Kitten'.split(' '))
    );
    ...
    $('img')
      .attr('title')
      .should.eql('Place Kitten');
  });

  it('class + src + width + title', () => {
    const $ = cheerio.load(
      img('left https://placekitten.com/200/300 200 Place Kitten'.split(' '))
    );
  ...
  it('class + src + width + height + title', () => {
    const $ = cheerio.load(
      img(
        'left https://placekitten.com/200/300 200 300 Place Kitten'.split(' ')
      )
    );
  ...
  it('class + src + width + height + title + alt', () => {
    const $ = cheerio.load(
      img(
        'left https://placekitten.com/200/300 200 300 "Place Kitten" "A cute kitten"'.split(
          ' '
        )
      )
    );
