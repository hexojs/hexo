...
describe('blockquote', () => {
  ...
  it('default', () => {
    ...
    result.should.eql(
      '<blockquote><p>123456 <strong>bold</strong> and <em>italic</em></p>\n</blockquote>'
    );
  });
  ...
  it('author', () => {
    ...
    result.should.eql(
      '<blockquote><footer><strong>John Doe</strong></footer></blockquote>'
    );
  });
  ...
  it('source', () => {
    ...
    result.should.eql(
      '<blockquote><footer><strong>Jane Austen</strong><cite>Pride and Prejudice</cite></footer></blockquote>'
    );
  });
  ...
  it('link', () => {
    ...
    result.should.eql(
      '<blockquote><footer><strong>John Doe</strong><cite><a href="https://hexo.io/">hexo.io</a></cite></footer></blockquote>'
    );
  });
  ...
  it('link title', () => {
    ...
    result.should.eql(
      '<blockquote><footer><strong>John Doe</strong><cite><a href="https://hexo.io/">Hexo</a></cite></footer></blockquote>'
    );
  });
